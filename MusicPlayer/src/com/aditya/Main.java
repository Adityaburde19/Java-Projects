...
public class Main {
	...
	public static void main(String[] args) {
		...
		Album album = new Album("Album1","Arjit Singh", null);
		
		album.addSong("Chaleya", 4);
		album.addSong("Satranga", 3.5);
		album.addSong("Heeriye", 4.5);
		albums.add(album);
		...
		albums.get(0).addToPlayList("Satranga", playList_1);
